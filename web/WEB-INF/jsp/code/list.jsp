                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="button" value="添加"
                               onclick="window.open('code/code', '_blank', 'height=200, width=400, top=100, left=100')"/>
                    </td>
                </tr>
            </table>
        </form>
                ...
                <tr>
                    ...
                    <td class="panel-dataGrid-dataColumn">
                        ...
                        <a href="javascript:void(0)"
                           onclick="window.open('code/code?codeId=${c.codeId}', '_blank', 'height=200, width=400, top=100, left=100')">更新</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
